       ...
       # Hey! WELCOME MY PYTHON COURSE
         # i'am Nafiz, from Bangladesh
...
# my balance 2500 taka 
deposite_balance = [2500]
# then betting 
win_bet = [ winniner*2 for winniner in deposite_balance]
print(win_bet)
# now my balance is 5000 taka
...
print(halved)
# output = [5.0, 11.0, 15.0, 20.0, 29.0, 31.0]
